            ...
            <div className="bg-white shadow-xl rounded-lg w-full max-w-2xl">
                ...
                <div className="p-6 sm:p-8 border-b border-gray-200 flex justify-between items-center">
                    ...
                    <button 
                        ...
                        className="ml-4 flex-shrink-0 text-sm font-medium text-green-600 hover:text-green-500 focus:outline-none focus:underline"
                    >
                        Sign Out
                    </button>
                </div>
                    ...
                    <div className="flex flex-col sm:flex-row sm:justify-end sm:space-x-3 pt-4 space-y-3 sm:space-y-0">
                        {isEditing ? (
                            ...
                            <button
                                type="button"
                                onClick={handleEdit}
                                className="w-full sm:w-auto flex justify-center py-2 px-6 border border-transparent rounded-md shadow-sm text-sm font-medium text-white bg-green-600 hover:bg-green-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-green-500"
                            >
                                Edit Profile
                            </button>
                        )}
